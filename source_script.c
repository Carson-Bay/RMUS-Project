...
int main(int argc, char *argv[]) {
  ...
  // Build the pipeline
  gst_bin_add_many(GST_BIN(data.pipeline), data.source, data.convert, data.encode, data.pay, data.sink, NULL);
  if (!gst_element_link_many(data.convert, data.encode, data.pay, data.sink, NULL)) {
